 ...
 */
export default function AsyncBulkUpload(props){
...
/**
 * 
 * @param {{files:Array<Object>,update:Function,loading:Boolean}} props 
 * @param {Array<Object>} props.files Array of pseudo file objects with metadata about state.
 * @param {Function} props.update Update the parent component data array.
 * @param {Boolean} props.loading Hacky way to update the display without updating the files array.
 */
function FileDisplay(props){
    /** Set of currently uploading files. */
    const [fileIterator, setFileIterator] = React.useState([]);

    /** Update the file iterator whenever props change. */
    useEffect(()=>{
        if(props.files){
    ...
    /** Delete element from parent list. */
                    ...
                    fileIterator.map((e,i)=>{
                        ...
                        <div className="file-display-info" key={i}>
                            <div className="file-display-name">
                                <input defaultValue={fileIterator[i].name} 
                                        onChange={(e)=>fileIterator[i].name=e.target.value} 
